...
public class Users implements JSONSerializable {
    ...
    private static final String FILE_PATH = "src/json/users.json"; // JSON file to store user data

    public Users() {
        this.keys = new ArrayList<>();
        loadExistingUsers(); // Automatically load existing users
    }
    ...
    public JSONType toJSONType() {
        ...
        for (User user : this.keys) {  // Use the correct list 'keys'
