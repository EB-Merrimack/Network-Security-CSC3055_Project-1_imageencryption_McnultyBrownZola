...
const { Photo, KeyEntry, User, Photos, Users } = require('./data');
...
const photosData = loadJsonFile(photosFilePath) || { photos: [] };
const usersData = loadJsonFile(usersFilePath) || { users: [] };
